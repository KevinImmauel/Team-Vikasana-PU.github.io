    ...
    return (
        <div className="">
            <div className="text-blue-950 w-full flex items-center justify-between sticky top-0 py-[10px] px-10 lg:py-[40px] bg-[#ECEDF1] lg:px-40">
                <a href="/" className="text-[28px] lg:text-[28px] font-normal font-['Monument Extended'] tracking-wide">
                    vikasana
                </a>
                <div className="hidden md:flex lg:text-xl justify-between w-[60%] lg:w-[52%] font-semibold">
                ...
                <div className="md:hidden">
                    <button onClick={togNavBar}>{isOpen ? <X /> : <Menu />}</button>
                </div>
            </div>
